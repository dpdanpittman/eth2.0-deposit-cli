...
def get_password() -> str:
    ...
    while not is_valid_password:
        password = click.prompt("Type the password that secures your validator keystore(s)",
                                hide_input=True, show_default=False, type=str)
        try:
            ...
            # Confirm password
            password_confirmation = click.prompt("Repeat for confirmation",
                                                 hide_input=True, show_default=False, type=str)
